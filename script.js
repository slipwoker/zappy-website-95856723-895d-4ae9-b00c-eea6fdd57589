    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const fieldName = input.getAttribute('data-name') || input.getAttribute('name') || input.placeholder || 'This field';
        ...
        contactForm.addEventListener('blur', function(e) {
            const input = e.target;
            if (input.matches('input, textarea, select') && input.value.trim()) {
                validateField(input);
            }
        }, true);
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '95856723-895d-4ae9-b00c-eea6fdd57589',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '95856723-895d-4ae9-b00c-eea6fdd57589';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '95856723-895d-4ae9-b00c-eea6fdd57589';
